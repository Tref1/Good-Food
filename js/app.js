(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".contents-page__slider")) new core(".contents-page__slider", {
            ...
            if (document.querySelector(".item-simple__slider")) new core(".item-simple__slider", {
        ...
        const menu = burgerMenu.closest(".navigation-header");
        if (burgerMenu) burgerMenu.addEventListener("click", (function(e) {
            if (menu) menu.classList.toggle("burger-open");
        }));
        const playBtn = document.querySelector(".item-simple__play-decor");
        const videoContainer = document.querySelector(".video-simple");
        const videoCloseBtn = document.querySelector(".video-simple__clouse");
        function openVideo() {
